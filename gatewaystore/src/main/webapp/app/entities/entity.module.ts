  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        loadChildren: () => import('./producto-detalle/producto-detalle.module').then(m => m.GatewaystoreProductoDetalleModule)
      },
      {
        path: 'detalle',
        loadChildren: () => import('./detalle/detalle.module').then(m => m.GatewaystoreDetalleModule)
      },
      {
        path: 'stock',
